...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:myport_v1_0:1.0\
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins myport_v1_0_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
