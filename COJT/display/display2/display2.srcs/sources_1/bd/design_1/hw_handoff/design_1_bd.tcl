...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins display_0/ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins regbus_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_125M/slowest_sync_clk]
  ...
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets regbus_0_BYTEEN]
  connect_bd_net -net regbus_0_RDADDR [get_bd_pins display_0/RDADDR] [get_bd_pins regbus_0/RDADDR]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets regbus_0_RDADDR]
  connect_bd_net -net regbus_0_RDEN [get_bd_pins display_0/RDEN] [get_bd_pins regbus_0/RDEN]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets regbus_0_RDEN]
  connect_bd_net -net regbus_0_WDATA [get_bd_pins display_0/WDATA] [get_bd_pins regbus_0/WDATA]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets regbus_0_WDATA]
  connect_bd_net -net regbus_0_WRADDR [get_bd_pins display_0/WRADDR] [get_bd_pins regbus_0/WRADDR]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets regbus_0_WRADDR]
  connect_bd_net -net regbus_0_WREN [get_bd_pins display_0/WREN] [get_bd_pins regbus_0/WREN]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets regbus_0_WREN]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins display_0/ARESETN] [get_bd_pins dispsub_0/ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins regbus_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn]
