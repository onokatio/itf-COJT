...
proc create_root_design { parentCell } {
  ...
  # Create instance: ps2if_0, and set properties
  set ps2if_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ps2if:1.0 ps2if_0 ]
  ...
  connect_bd_intf_net -intf_net capture_0_M_AXI [get_bd_intf_pins axi_smc_1/S00_AXI] [get_bd_intf_pins capture_0/M_AXI]
  connect_bd_intf_net -intf_net display_0_M_AXI [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins display_0/M_AXI]
  connect_bd_intf_net -intf_net draw_0_M_AXI [get_bd_intf_pins axi_smc_1/S01_AXI] [get_bd_intf_pins draw_0/M_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins sccb_0/s00_axi]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps2if_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net sound_0_M_AXI [get_bd_intf_pins axi_smc_1/S02_AXI] [get_bd_intf_pins sound_0/M_AXI]
  ...
  connect_bd_net -net Net [get_bd_ports PS2CLK] [get_bd_pins ps2if_0/PS2CLK]
  connect_bd_net -net Net1 [get_bd_ports PS2DATA] [get_bd_pins ps2if_0/PS2DATA]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins capture_0/ACLK] [get_bd_pins display_0/ACLK] [get_bd_pins draw_0/ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins ps2if_0/s00_axi_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins regbus_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_125M/slowest_sync_clk] [get_bd_pins sccb_0/s00_axi_aclk] [get_bd_pins sound_0/ACLK]
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins capture_0/ARESETN] [get_bd_pins display_0/ARESETN] [get_bd_pins dispsub_0/ARESETN] [get_bd_pins draw_0/ARESETN] [get_bd_pins ps2if_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins regbus_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_125M/peripheral_aresetn] [get_bd_pins sccb_0/s00_axi_aresetn] [get_bd_pins sound_0/ARESETN]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces capture_0/M_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces draw_0/M_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ps2if_0/s00_axi/reg0] SEG_ps2if_0_reg0
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sccb_0/s00_axi/reg0] SEG_sccb_0_reg0
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces sound_0/M_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_0_HP2_DDR_LOWOCM
